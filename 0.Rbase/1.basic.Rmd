...
[1. R 개요 및 설치](#1.-r-개요-및-설치)  

[2. 데이터 다루기](#2.-데이터-다루기)  
- [2-1. 데이터 타입](#2-1.-데이터-타입)      
- [2-2. 데이터 구조](#2-2.-데이터-구조)  
    - [벡터(Vector)](#--벡터(Vector))  
    - [매트릭스(Matrix)](#--매트릭스(Matrix))  
    - [배열(Array)](#--배열(Array))  
    - [리스트(List)](#--리스트(List))  
    - [데이터프레임(data.frame)](#--데이터-프레임(data.frame))  
- [2-3. 기본문법](#2-3.-기본문법)  
    - [구문](#--구문)  
    - [비교연산자](#--비교연산자)  

[3. 데이터 가공](http://www.opensquared.org/home/program/education.do)  

[4. 데이터 시각화](http://www.opensquared.org/home/program/education.do)
<br/>
...
- R에서 다루는 가장 작은 데이터 단위 ex) Numerical, Character ...
- **동일한 타입** 의 스칼라가 여러개 모인 것, `typeof(변수)`로 벡터타입을 확인할 수 있다.  
- **Combine 함수**를 이용하여 여러 값으로 구성할 수 있다.  
- 항목에 접근할 때 **[ ]** 를 사용한다.  
